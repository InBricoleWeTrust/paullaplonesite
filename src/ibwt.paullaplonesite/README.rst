...
.. contents::
BUILDOUT FOR paullaplonesite DOCUMENTATION
==============================================================
INSTALLING THIS PROJECT
-----------------------------------------
::

    git clone git@gitorious-git.makina-corpus.net/ paullaplonesite
    cd paullaplonesite
...
- jpcw <contact@inbricolewetrust.net>  <contact@inbricolewetrust.net>
