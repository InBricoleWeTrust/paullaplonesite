...
def upgrade_1000(context):
    ...
    #portal_setup.runImportStepFromProfile(
    #    'profile-ibwt.paullaplonesite:default', 'jsregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-ibwt.paullaplonesite:default', 'cssregistry', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-ibwt.paullaplonesite:default', 'portlets', run_dependencies=False)
    #portal_setup.runImportStepFromProfile(
    #   'profile-ibwt.paullaplonesite:default', 'propertiestool', run_dependencies=False)
    log('v1000 applied')
