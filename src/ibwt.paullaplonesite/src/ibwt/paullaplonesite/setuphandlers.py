...
from ibwt.paullaplonesite import PRODUCT_DEPENDENCIES

logger = logging.getLogger('ibwt.paullaplonesite / setuphandler')
...
def setupVarious(context):
    ...
    if context.readDataFile('ibwt.paullaplonesite_various.txt') is None:
        return
...
def setupQi(context):
    ...
    if context.readDataFile('ibwt.paullaplonesite_qi.txt') is None:
        return

    portal = context.getSite()
    portal_quickinstaller = getToolByName(portal, 'portal_quickinstaller')
    #portal_setup = getToolByName(portal, 'portal_setup')
    logger = logging.getLogger('ibwt.paullaplonesite.Install')
