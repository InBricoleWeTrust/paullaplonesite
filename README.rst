==============================================================
BUILDOUT FOR ibwt.paullaplonesite DOCUMENTATION
==============================================================
...
::
    ...
    cd ibwt.paullaplonesite
    mkdir workdir
    git clone git@gitorious-git.makina-corpus.net/ ibwt.paullaplonesite
...
PROJECT Files
~~~~~~~~~~~~~~~~~~~~~~~~
- Think you have the most important sections of this buildout configuration in etc/ibwt.paullaplonesite.cfg
